<%-- 
    ...
    Created on : Jul 24, 2023, 7::29 AM
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>quản lí <b>Sản phẩm</b></h2>
                              ...
                              <a class="btn-success"  href="index">Trang chủ</a>
                        ...
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete?pid=${o.id}" class="delete" data-toggle="modal" onclick="return confirmDelete();">
